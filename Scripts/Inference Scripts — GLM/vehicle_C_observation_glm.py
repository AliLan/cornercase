...
def get_triples_from_llm(image_paths, prompt):
    ...
    try:
        ...
        raw_output = glm_processor.batch_decode(
...
for scenario in SCENARIOS:
    ...
    for weather in sorted(os.listdir(scenario_folder)):
        ...
        print(f"Processing scenario: {scenario}, weather: {weather}, vehicle: C")
        ...
        while loop < len(rgb_images):
            ...
            loop_output_path = os.path.join(CORNERCASE_DIR, "outputs_new", "glm", scenario, weather, str(loop + 1))
