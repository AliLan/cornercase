...
def get_triples_from_llm(image_paths, prompt):
    ...
    return _extract_ttl(raw_output), call_metrics
...
prompt = """\
DO NOT write English sentences. DO NOT answer yes or no. Output ONLY Turtle RDF lines.

If a vehicle is clearly occluded by another vehicle in the image, copy ALL lines exactly:
...
If NO vehicle is occluded, copy ONLY this one line:
ex:vehiclePolice_activity a prov:Activity ."""
